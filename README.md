...
# Full pipeline — collect BloodHound data, import, graph analysis, ADCS triage
...
# Save output to file
python3 chainforge.py -u <user> -p '<password>' -d <domain> --dc-ip <dc_ip> --neo4j -o report.txt
